            ...
            <Slider {...settings}>
                {products.map((product) => (
                    <div key={product.uniq_id} className="relative w-full">
                        ...
                        <div className="lg:hidden relative min-h-[450px]">
                            <div
                            ...
                            <div className="absolute h-full flex flex-col justify-end p-4 md:p-6 space-y-4">
                                {/* Text content is now at the bottom */}
                                <h1 className="text-xl md:text-2xl font-bold text-white leading-tight">
                                    <span className="block">
                                        {product.product_name}
                                    </span>
                                </h1>
                                <p className="text-white/90 text-sm md:text-md max-w-lg">
                        ...
                        {/* Desktop Layout (Grid) */}
                        <div className="hidden lg:block min-h-[450px] bg-gray-200">
